...
const PreNavbar = () => {
    ...
    return (
        <div className="preNav">
            <div>
                <Link to="/">ECOMERCE</Link> <span>|</span>
                {/* {/* <a to="https://in.event.mi.com/in/install-mi-store">GET MI STORE APP</a> <span>|</span> */}
            ...
            <div>
                ...
                <a to="https://store.mi.com/in/site/login">{cartIcon}  CART (0)</a>
